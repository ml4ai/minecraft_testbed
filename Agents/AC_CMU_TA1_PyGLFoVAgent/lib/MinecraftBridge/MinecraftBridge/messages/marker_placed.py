# -*- coding: utf-8 -*-
"""
.. module:: marker_placed
   :platform: Linux, Windows, OSX
   :synopsis: Message class encapsulating Marker Placed Events

.. moduleauthor:: Dana Hughes <danahugh@andrew.cmu.edu>

Definition of a class encapsulating Marker Placed Event messages.
"""
...
class MarkerPlacedEvent(BaseMessage):
    """
    A class encapsulating Marker Placed Event messages.
    ...
    def __str__(self):
        ...
        -------
        string
            Class name of the message (i.e., 'MarkerPlacedEvent')
        """
    ...
    def playername(self):
        """
        Get the name of the player who placed the marker.  Attempting to set
    ...
    def participant_id(self):
        """
        Get the participant_id of the player who placed the marker.
    ...
    def marker_type(self):
        """
        Get the type of marker placed.  Attempting to set the value of 
    ...
    def toDict(self):
        """
        Generates a dictionary representation of the MarkerPlacedEvent message.
        MarkerPlaced information is contained in a dictionary under the key 
        "data".  Additional named headers may also be present.

        Returns
        -------
        dict
            A dictionary representation of the MarkerPlacedEvent.
        """
        ...
        jsonDict["data"]["type"] = self.type.value
    ...
    def toJson(self):
        """
        Generates a JSON representation of the MarkerPlacedEvent message.  
        MarkerPlacedEvent information is contained in a JSON object under the
