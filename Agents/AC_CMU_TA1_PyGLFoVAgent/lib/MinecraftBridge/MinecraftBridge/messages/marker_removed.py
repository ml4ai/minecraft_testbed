# -*- coding: utf-8 -*-
"""
.. module:: marker_removed
   :platform: Linux, Windows, OSX
   :synopsis: Message class encapsulating Marker Removed Events

.. moduleauthor:: Dana Hughes <danahugh@andrew.cmu.edu>

Definition of a class encapsulating Marker Removed Event messages.
"""
...
class MarkerRemovedEvent(BaseMessage):
    """
    A class encapsulating Marker Removed Event messages.  Marker Removed Events
    occur when a player removes an existing marker in the environment.

    Attributes
    ----------
    playername : string
        The name of the player that placed the marker
    name : string
        Alias of `playername`
    type : string
    ...
    participant_id : string
            Name of the player that placed the marker
    """
    ...
    def __init__(self, **kwargs):
        ...
        # Marker type needs to be coerced to a MinecraftElements.Block
        # instance.  Set to "UNKNOWN" if it's not a valid block
        try:
            self._marker_type = MinecraftElements.Block[self._marker_type.replace(' ','')]
        except KeyError:
            self.logger.warning("%s: Trying to parse unknown block type %s", self, self._marker_type)
            self._marker_type = MinecraftElements.Block["UNKNOWN"]
    ...
    def __str__(self):
        ...
        -------
        string
            Class name of the message (i.e., 'MarkerRemovedEvent')
        """
    ...
    def playername(self):
        """
        Get the name of the player who removed the marker.  Attempting to set
    ...
    def participant_id(self):
        """
        Get the participant_id of the player who removed the marker.
        Attempting to set the value of `participant_id` will raise an
        `ImmutableAttributeException`.
        """
    ...
    def marker_type(self):
        """
        Get the type of marker removed.  Attempting to set the value of 
    ...
    def toDict(self):
        """
        Generates a dictionary representation of the MarkerRemovedEvent message.
        MarkerRemoved information is contained in a dictionary under the key 
        "data".  Additional named headers may also be present.

        Returns
        -------
        dict
            A dictionary representation of the MarkerRemovedEvent.
        """
    ...
    def toJson(self):
        """
        Generates a JSON representation of the MarkerRemovedEvent message.  
        MarkerRemovedEvent information is contained in a JSON object under the
