# -*- coding: utf-8 -*-
"""
.. module:: item_drop_event
   :platform: Linux, Windows, OSX
   :synopsis: Message class encapsulating Item Drop Events

.. moduleauthor:: Dana Hughes <danahugh@andrew.cmu.edu>

Definition of a class encapsulating Item Drop Event messages.
"""
...
class ItemDropEvent(BaseMessage):
    """
    A class encapsulating ItemDropEvent messages.

    Note
    ----
    Constructing an ItemDropEvent message requires passing the following keyword
    arguments:
    ...
    def __str__(self):
        ...
        -------
        string
            Class name of the message (i.e., 'ItemDroppedEvent')
        """
    ...
    def playername(self):
        """
        Get the name of the player who dropped the item.  
    ...
    def item_x(self):
        """
        x location of the dropped item (i.e., alias of `location[0]`)
        """
    ...
    def item_y(self):
        """
        y location of the dropped item (i.e., alias of `location[1]`)
        """
    ...
    def item_z(self):
        """
        x location of the dropped item (i.e., alias of `location[2]`)
        """
    ...
    def itemName(self):
        """
        Get the name of the item dropped.  
    ...
    def toDict(self):
        ...
        -------
        dict
            A dictionary representation of the ItemDroppedEvent.
        """
