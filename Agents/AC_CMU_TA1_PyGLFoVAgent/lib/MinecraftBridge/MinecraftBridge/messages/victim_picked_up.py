# -*- coding: utf-8 -*-
"""
.. module:: victim_picked_up
   :platform: Linux, Windows, OSX
   :synopsis: Message class encapsulating Victim Picked Up Events

.. moduleauthor:: Dana Hughes <danahugh@andrew.cmu.edu>

Definition of a class encapsulating Victim Picked Up Event messages.
"""
...
class VictimPickedUp(BaseMessage):
    """
    A class encapsulating VictimPickedUp messages.
    ...
    participant_id: string
        Unique identifier of participant who picked up the victim (e.g. "P000420")
    playername : string
        Name of the player who picked up the victim
    name : string
        Alias of `playername`
    victim_id : int
    ...
    def __str__(self):
        ...
        -------
        string
            Class name of the message (i.e., 'VictimPickedUp')
        """
    ...
    def participant_id(self):
        """
        Get the unique identifier for the participant who picked up the victim.  
    ...
    def playername(self):
        """
        Get the name of the player who picked up the victim.  Attempting to set
    ...
    def type(self):
        """
        Get the type of victim picked.  Attempting to set the value of `type`
    ...
    def victim_id(self):
        """
        Get the id of victim picked up.  Attempting to set the value of `victim_id`
        will result in an `ImmutableAttributeException` being raised.
        """
    ...
    def toDict(self):
        """
        Generates a dictionary representation of the VictimPickedUp message.
        VictimPickedUp information is contained in a dictionary under the key 
        "data".  Additional named headers may also be present.

        Returns
        -------
        dict
            A dictionary representation of the VictimPickedUp message.
        """
    ...
    def toJson(self):
        """
        Generates a JSON representation of the VictimPickedUp message.  
        VictimPickedUp information is contained in a JSON object under the
