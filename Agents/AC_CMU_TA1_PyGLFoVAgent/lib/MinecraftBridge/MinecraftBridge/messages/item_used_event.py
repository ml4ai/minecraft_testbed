# -*- coding: utf-8 -*-
"""
.. module:: item_used_event
   :platform: Linux, Windows, OSX
   :synopsis: Message class encapsulating Item Used Events

.. moduleauthor:: Dana Hughes <danahugh@andrew.cmu.edu>

Definition of a class encapsulating Item Used Event messages.
"""
...
class ItemUsedEvent(BaseMessage):
    """
    A class encapsulating ItemUsedEvent messages.

    Note
    ----
    Constructing an ItemUsedEvent message requires passing the following keyword
    arguments:
    ...
    def playername(self):
        """
        Get the name of the player who used the item.  
    ...
    def location(self):
        """
        Get the location where the item was used.  
    ...
    def item_x(self):
        """
        x location of the used item (i.e., alias of `location[0]`)
        """
    ...
    def item_y(self):
        """
        y location of the used item (i.e., alias of `location[1]`)
        """
    ...
    def item_z(self):
        """
        x location of the used item (i.e., alias of `location[2]`)
        """
