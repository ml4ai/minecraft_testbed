# -*- coding: utf-8 -*-
"""
.. module:: proximity_victim_interaction_event
   :platform: Linux, Windows, OSX
   :synopsis: Message class encapsulating Proximity Victim Interaction Events

.. moduleauthor:: Dana Hughes <danahugh@andrew.cmu.edu>

Definition of a class encapsulating Proximity Victim Interaction Event messages.
"""
...
class ProximityVictimInteractionEvent(BaseMessage):
    """
    A class encapsulating ProximityVictimInteractionEvent messages.
    ...
    action_type : enum
        Action performed, of type ActionType
    ...
    players_in_range : int
        Number of players within range of the victim
    type : string
