package com.asist.asistmod.missionhelpers.Scoreboard.CustomBaseClasses;
...
public class BaseScoreboard extends Scoreboard
{
    ...
    public Collection<Score> getSortedScores(ScoreObjective objective)
    {
        ...
        //list.forEach( s -> System.out.println( s.getPlayerName() + " : " + s.getScorePoints()) );
        
        //Collections.sort(list, this.CUSTOM_COMPARATOR);
    ...
    public static final Comparator<Score> CUSTOM_COMPARATOR = new Comparator<Score>()
    {
