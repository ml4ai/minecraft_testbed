...
# # messages == 1 and trial != Training

def ac_cmu_ta2_beard_test(name,lines,table:dict):
        ...
        try: 
            ...
            if ( isTrainingMission == False):
                if ('topic' in json_line):
                    ...
                    if(topic == 'agent/ac/ac_cmu_ta2_beard/beard'):
                        num_beard_messages+=1
    ...
    output[name+'_'+str(len(output.items()))] = name, str(boolean1) , '# num beard messages : ' + str(num_beard_messages),"# messages == 1 and trial != Training"   
