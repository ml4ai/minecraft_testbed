...
def ac_gallup_ta2_gelp_test(name,lines,table:dict):
    ...
    if (num_gelp_messages != 0):
        
        boolean1 = (elapsed_milliseconds/num_gelp_messages <= (1000*60*2) )
   
        out = (elapsed_milliseconds/num_gelp_messages  )
